...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg = err?.response?.data?.message || "Couldn't create your account. Try again.";
      setError(msg);
    } finally {
      setLoading(false);
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Create an account to write and save what you love.
        </p>
        ...
        >
          ...
          <Link to="/login" style={{ color: "var(--color-amber)", fontWeight: 600, textDecoration: "none" }}>
            Sign in
          </Link>
        </p>
      </motion.div>
